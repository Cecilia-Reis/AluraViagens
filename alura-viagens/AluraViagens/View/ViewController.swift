...
class ViewController: UIViewController {
    ...
    func irParaDetalhe(_ viagem:Viagem?) {
        if let viagemSelecionada = viagem {
            let detallheController = DetalheViewController.instanciar(viagemSelecionada)
            navigationController?.pushViewController(detallheController, animated: true)
        }
    }
}
...
extension ViewController: OfertaTableViewDelegate{
